 # Deploy Workload (ASP.NET Core Docker web app) and the Fabrikam Drone Delivery app
...
**Step 2 - after the infrastructure is proved to be functioning, procceed with the Fabrikam Drone Delivery app**
